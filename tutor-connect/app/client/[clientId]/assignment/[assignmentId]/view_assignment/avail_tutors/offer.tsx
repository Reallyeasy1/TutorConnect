...
export const OfferForm: FC<OfferFormProps> = ({ assignmentId, tutor, clientId }) => {
			...
			<DialogContent>
				<form onSubmit={onSubmit}>
					<DialogHeader>
						...
						<DialogDescription>Fill in the details below to place an offer for this tutor.</DialogDescription>
					</DialogHeader>
					{assignment && (
						<>
					...
					<DialogFooter>
						<Button style={styles.blueButton} disabled={submit}>
							{submit ? (
								<>
									<Spinner /> Sending Offer...
								</>
							) : (
								"Send Offer"
							)}
