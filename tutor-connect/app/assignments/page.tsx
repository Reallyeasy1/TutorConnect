            ...
            {assignments.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-8">
                    {assignments.map((assignment) => (
                        <div key={assignment.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow w-full max-w-3xl">
                            ...
                            <p className="text-gray-700 mb-1"><strong>Post Date:</strong> {new Date(assignment.postDate).toLocaleDateString()}</p>
                            <p className="text-gray-700 mb-1"><strong>Client:</strong> {assignment.client.name}</p>
